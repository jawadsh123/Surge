...
if( $_POST ) {
  ...
  $query = "INSERT INTO `BigData`(`Name`, `Email`, `Contact`, `College` , `Branch` , `Year`) VALUES ('$name','$mail','$contact','$college','$branch','$year')";

  if(mysql_query($query)){

    echo "<h2>Thank you for Registering</h2><h2>Our associates will soon reach you</h2>";
