          ...
          <div class="hero-message hero-left">
            <div class="row">
                ...
                <div class="col-md-6 hidden-sm hidden-xs hero-text">
                    <h2 class="color-blue">Let's Build a smart Future</h2>
                      ...
                      <div class="tab-content">
                        ...
                        <div class="tab-pane fade in active" id="tab-one">
                          <ul>
                              ...
                              <li><h4>esting and Distributing Android Applications</h4>
                                  <p>
                                  <ol>
                        ...
                        <div class="tab-pane fade" id="tab-two">
                          ...
                          <p>
                         <strong>Vipul Shah</strong> obsessed over the best ways to develop~learn~and~teach software development, is developing Android and iOS mobile apps for over 6 years. He is currently working as Android Engineer at Microsoft.
                          </p>
                        </div>
                        ...
                        <div class="tab-pane fade" id="tab-three">
                            ...
                            <p><strong>Rs. 8,000/- per head for a group of 4</strong></p>

                            <p>Valid till Jan 18 only!</p>
                        </div>
